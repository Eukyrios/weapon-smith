...
SECTIONS = {
  ...
  'mcx-lt': [
    ...
    ('muzzle', 'Muzzle', 'On the bare rifle and it stays there, even under the Fierce Barrel &mdash; that barrel is drawn with a can already on the front, and neither recording of it shows a muzzle chip, but the game still lets one be fitted. So this slot is one of two here with a table and no chip on the stage.'),
    ...
    ('rear-grip-patch', 'Rear grip patch', 'Opened by the AR Modular Rear Grip, which rules the mount out in exchange. Two pieces, neither in the catalogue.'),
